...
<div id="ng-app" class="row workspace-top public-profile">
    ...
    <div class="span3 lhs">
    	<div class="workspace-left workspace-profile">
            ...
            <p><small id="orcid-id" class="orcid-id">${(profile.orcidId)!}</small></p>
	        <p class="hoover-white-fonts"><a href="${(profile.orcidId)!}" class="label btn-primary"><@orcid.msg 'workspace.ViewPublicORCIDRecord'/></a></p>
